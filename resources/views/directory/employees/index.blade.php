            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="GET" action="{{ url('/admin/employees') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($employees as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->email }}</td><td>{{ $item->cname }}</td>
                                        <td>
                                            <a href="{{ url('/admin/employees/' . $item->id) }}" title="View employee"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/employees/' . $item->id . '/edit') }}" title="Edit employee"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
